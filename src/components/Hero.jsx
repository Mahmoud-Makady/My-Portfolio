...
const Hero = () => {
  ...
  <div className="container flex flex-col-reverse lg:grid lg:grid-cols-2 lg:gap-10">
    ...
    <div className="flex justify-center lg:justify-end">
      <figure className="w-3/4 sm:max-w-[400px] lg:max-w-full mx-auto bg-gradient-to-t from-slate-400 via-25% via-slate-400/40 to-65% rounded-[70px] overflow-hidden">
        <img
          src="/images/pic.jpg"
          alt="Mahmoud Makady"
