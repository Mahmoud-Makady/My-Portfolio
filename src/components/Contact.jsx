const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M20 4H4C2.9 4 2 4.9 2 6v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2Zm-1 2-7 5-7-5h14Zm1 12H4V8l8 5.99L20 8v10Z"
          fill="currentColor"
        />
      </svg>
    ),
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2  reveal-up">
            Ready to Collaborate? <br /> Get in Touch and Let's Create Something
            Amazing!
          </h2>
