  ...
  return (
    ...
    id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <form 
                action="https://getform.io/f/alllmoqa" 
                method="post" 
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                          <label htmlFor="name" className="label reveal-up">
                            ...
                            <input type="text" name="name"
                              id="name" autoComplete="name" required placeholder="Abdulrahman Khalifa" className="text-field reveal-up" />
                        </div>
                      ...
                      <div className="mb-4">
                          ...
                          <input type="email" name="email"
                              id="email" autoComplete="email" required placeholder="abdoali@gmail.com" className="text-field reveal-up" />
                      </div>
                    </div>
