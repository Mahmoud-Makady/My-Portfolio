...
const socialLinks = [
    ...
    },
    {
        ...
        <path d="M12 2C6.48 2 2 6.48 2 12c0 2.18.7 4.2 1.88 5.88L2 22l4.24-1.12A9.96 9.96 0 0 0 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2Zm0 18a8.01 8.01 0 0 1-4.15-1.15l-.3-.18-2.52.67.67-2.46-.19-.31A7.95 7.95 0 0 1 4 12c0-4.42 3.58-8 8-8s8 3.58 8 8-3.58 8-8 8Zm3.67-5.92c-.2-.1-1.18-.58-1.36-.64-.18-.06-.3-.1-.43.1-.13.2-.5.64-.62.78-.12.14-.23.16-.43.05-.2-.1-.84-.31-1.6-1-.59-.52-.99-1.16-1.1-1.36-.12-.2 0-.31.09-.4.1-.1.2-.23.3-.35.1-.12.13-.2.2-.33.07-.13.03-.25-.02-.35-.05-.1-.43-1.02-.59-1.4-.16-.38-.32-.32-.43-.33-.12-.01-.24-.01-.37-.01a.71.71 0 0 0-.52.24c-.17.19-.68.66-.68 1.62s.7 1.88.8 2.02c.1.14 1.38 2.1 3.35 2.94.47.2.84.32 1.13.41.48.15.92.13 1.27.08.39-.06 1.18-.48 1.34-.95.16-.47.16-.87.12-.95-.04-.08-.15-.13-.34-.23Z"/>
      </svg>,
        alt: 'WhatsApp'
    },
    ...
    id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                  ...
                  Ready to Collaborate? <br /> Get in Touch and Let's Create Something Amazing!
                </h2>
                    ...
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                          <label htmlFor="name" className="label reveal-up">
                            ...
                            <input type="text" name="name"
                              id="name" autoComplete="name" required placeholder="Mahmoud Makady" className="text-field reveal-up" />
                        </div>
                      ...
                      <div className="mb-4">
                          ...
                          <input type="email" name="email"
                              id="email" autoComplete="email" required placeholder="m.makady19@gmail.com" className="text-field reveal-up" />
                      </div>
                    </div>
